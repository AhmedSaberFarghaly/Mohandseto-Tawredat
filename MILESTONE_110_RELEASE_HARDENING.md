...
Final screen-matrix reconciliation also replaced stale placeholders with live company/branch selection, persisted default-branch changes, branch/address details, compact profile data, a dedicated recently-viewed rail, and a correct suspended-account recovery state. The resulting honest gate is 753/756; OAuth and multi-company switching remain explicit rather than being marked complete without working credentials/data ownership semantics.
