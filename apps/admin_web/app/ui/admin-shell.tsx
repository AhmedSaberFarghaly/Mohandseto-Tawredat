...
const groups = [
  ...
  ["التحليلات والنظام", [["التقارير", "/dashboard/reports", "⌁"], ["المستخدمون والصلاحيات", "/dashboard/users", "♧"], ["الإعدادات", "/dashboard/settings", "⚙"], ["التكاملات", "/dashboard/integrations", "↗"], ["مراقبة النظام", "/dashboard/monitoring", "◉"]]],
] as const;
