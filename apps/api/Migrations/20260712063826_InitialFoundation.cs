        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsPlatformStaff = table.Column<bool>(type: "INTEGER", nullable: false),
                    AvatarPath = table.Column<string>(type: "TEXT", nullable: true),
                    PreferredLanguage = table.Column<string>(type: "TEXT", nullable: false),
                    DefaultBranchId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LegalNameEn = table.Column<string>(type: "TEXT", nullable: true),
                    CommercialRegistrationNo = table.Column<string>(type: "TEXT", nullable: true),
                    TaxCardNo = table.Column<string>(type: "TEXT", nullable: true),
                    Phone = table.Column<string>(type: "TEXT", nullable: false),
                    Email = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    EmployeeCountRange = table.Column<int>(type: "INTEGER", nullable: false),
                    CreditLimit = table.Column<decimal>(type: "TEXT", precision: 18, nullable: false),
                    CreditUsed = table.Column<decimal>(type: "TEXT", precision: 18, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasePrice = table.Column<decimal>(type: "TEXT", precision: 18, nullable: false),
                    CompareAtPrice = table.Column<decimal>(type: "TEXT", precision: 18, nullable: true),
                    TaxRatePercent = table.Column<decimal>(type: "TEXT", precision: 18, nullable: false),
                    ...
                    RatingAvg = table.Column<double>(type: "REAL", nullable: false),
                    RatingCount = table.Column<int>(type: "INTEGER", nullable: false),
                    WarrantyAr = table.Column<string>(type: "TEXT", nullable: true),
                    DeliveryEstimateDays = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyProductPrices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyProductPrices_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "TEXT", nullable: false),
                    NameAr = table.Column<string>(type: "TEXT", nullable: false),
                    ValueAr = table.Column<string>(type: "TEXT", nullable: false),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "TEXT", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuantityPriceTiers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuantityPriceTiers_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyProductPrices_ProductId",
                table: "CompanyProductPrices",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyProductPrices_TenantId_ProductId_ValidFrom",
                table: "CompanyProductPrices",
                columns: new[] { "TenantId", "ProductId", "ValidFrom" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuantityPriceTiers_ProductId_MinQty",
                table: "QuantityPriceTiers",
                columns: new[] { "ProductId", "MinQty" },
                unique: true);
