...
| قاعدة البيانات | SQLite (تطوير) → SQL Server (إنتاج) | 10 migrations حتى `ApprovalWorkflow` مطبقة ومختبرة على قاعدة فارغة |
...
| باقي الوحدات (RFQ، طلبات، مخزون، CRM…) | 0% — مجدولة M5–M9 |
...
| 3 | تغطية الاختبارات ما زالت تحتاج التوسع مع الوحدات القادمة | عالية | 27 اختبار Backend + 9 Flutter + E2E Catalog/Media/Cart/Checkout/Custom Products/Approvals |
...
4. **M5 (جارية — البوابة العامة 47%):** الموافقات الداخلية مكتملة؛ RFQ هو الجزء الجاري.
