...
> يُحدَّث هذا الملف عند كل تغيير جوهري في حالة المشروع. آخر تحديث: 2026-07-12 (بعد دفعة الكتالوج المتقدمة).
...
| قاعدة البيانات | SQLite (تطوير) → SQL Server (إنتاج) | 3 migrations حتى `CatalogSearchHistory` مطبقة |
...
| الكتالوج والرئيسية والبحث (شاشات 40–77) | 90% — البحث وسجله والمقارنة والتفاصيل تعمل؛ الشركة/الفروع وتنزيل الملفات مرتبطان بوحدات لاحقة |
| إدارة المنتجات والأقسام | 80% — Products/Categories/Brands/Variants وCSV import/export تعمل؛ الصور والمستندات والخصائص وأسعار الشركات ما زالت مطلوبة |
...
| 3 | تغطية الاختبارات ما زالت تحتاج التوسع مع الوحدات القادمة | عالية | 17 اختبار Backend + 3 اختبارات Flutter + E2E إداري كامل للكتالوج |
...
2. **M3 (جارية):** البحث والمقارنة وCRUD الأقسام والعلامات والمتغيرات وCSV مكتملة؛ Media/Attributes/Company pricing هي المتبقية.
