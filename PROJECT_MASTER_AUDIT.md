...
| السلة وCheckout (شاشات 109–151) | 12% — Cart API وFlutter الأساسيان يعملان؛ خطوات التوصيل والدفع والمراجعة قيد التنفيذ |
...
| 3 | تغطية الاختبارات ما زالت تحتاج التوسع مع الوحدات القادمة | عالية | 20 اختبار Backend + 3 اختبارات Flutter + E2E Catalog/Media/Cart |
...
3. **M4 (جارية):** Cart multi-tenant وأسعاره وSaved for Later مكتملة؛ Checkout والمخصصات تاليان.
