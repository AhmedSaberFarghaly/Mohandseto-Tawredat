...
> يُحدَّث هذا الملف عند كل تغيير جوهري في حالة المشروع. آخر تحديث: 2026-07-13 (Custom Products Workflow).
...
| قاعدة البيانات | SQLite (تطوير) → SQL Server (إنتاج) | 7 migrations حتى `CustomProductSamples` مطبقة ومختبرة على قاعدة فارغة |
...
| السلة وCheckout (شاشات 109–151) | 68% — Cart والتوصيل والدفع المؤسسي والمراجعة وإنشاء الطلب تعمل؛ الخرائط والمرفقات وبوابة البطاقة متبقية |
...
| 3 | تغطية الاختبارات ما زالت تحتاج التوسع مع الوحدات القادمة | عالية | 23 اختبار Backend + 7 Flutter + E2E Catalog/Media/Cart/Checkout/Custom Products |
...
3. **M4 (جارية):** المنتجات المخصصة وCart وCheckout المؤسسي الأساسي مكتملة؛ مرفق أمر الشراء ومراكز التكلفة والميزانيات والموقع على الخريطة وبوابة البطاقة هي المتبقية لإغلاق 40%.
