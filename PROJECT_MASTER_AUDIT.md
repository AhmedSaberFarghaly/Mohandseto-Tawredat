...
> يُحدَّث هذا الملف عند كل تغيير جوهري في حالة المشروع. آخر تحديث: 2026-07-12 (Milestone 30).
...
| باقي الوحدات (مخصص، موافقات، RFQ، طلبات، مخزون، CRM…) | 0% — مجدولة M4–M9 |
...
| 3 | تغطية الاختبارات ما زالت تحتاج التوسع مع الوحدات القادمة | عالية | 21 اختبار Backend + اختبارات Flutter + E2E Catalog/Media/Cart/Checkout |
...
3. **M4 (جارية):** Cart وCheckout المؤسسي الأساسيان مكتملان؛ المخصصات والخرائط والمرفقات وبوابة الدفع تالية.
