...
| قاعدة البيانات | SQLite (تطوير) → SQL Server (إنتاج) | 9 migrations حتى `CartOperations` مطبقة ومختبرة على قاعدة فارغة |
...
| السلة وCheckout (شاشات 109–151) | 95% — حفظ السلة والكوبونات وتغير السعر والتوفر والملاحظات مع Checkout المؤسسي الكامل تعمل؛ العرض البنكي التفصيلي وإيصال التحويل متبقيان |
...
| 3 | تغطية الاختبارات ما زالت تحتاج التوسع مع الوحدات القادمة | عالية | 26 اختبار Backend + 9 Flutter + E2E Catalog/Media/Cart/Checkout/Custom Products |
...
3. **M4 (جارية — البوابة العامة 43%):** المنتجات المخصصة والسلة وCheckout المؤسسي المتقدم مكتملة؛ تفاصيل التحويل البنكي وإيصال التحويل هي المتبقية لإغلاق الوحدة.
